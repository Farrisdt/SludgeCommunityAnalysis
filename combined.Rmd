...
# Top 3 orders of top 3 classes by Bin
...
p = plot_nested_bar(top_nested$ps_obj,
  ...
  theme(plot.title = element_text(hjust = 0.5, 
        ...
        legend.key.size = unit(10, 
                               "points"))
p
ggsave("top_3_classes_top5_order_bin.png", plot = p, path = "./files/images/relative_abundance", width = 9000, height = 4000, units = "px", dpi = 380)
```
...
p = stressplot(physeq_ord) # plot shepard diagram to visualize goodness of fit# 
ggsave("nmds_shepard_stress_diagram.png", plot = p, path= "./files/images/beta_diversity")
...
p1
ggsave("nmds_Bin.png", plot = p1, path= "./files/images/beta_diversity")
