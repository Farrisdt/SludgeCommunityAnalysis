...
p = plot_bar(phyobj_parcu, "Order", fill="Order", facet_grid=~Media.Type.1) + geom_bar(aes(color=Order, fill=Order), stat="identity", position="stack") + ggtitle("Parcubacteria Abundances") + ylab ("Abundance (arbitraty units)")
